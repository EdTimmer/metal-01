...
const Letter = forwardRef<Mesh, Props>(({ position, rotation, text, color, size, depth, materialProps }, letterRef) => {
  ...
  return (
    <mesh ref={letterRef} geometry={textGeometry} rotation={rotation} position={position}>
